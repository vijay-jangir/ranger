...
public class RangerDatahubEntityWithTags {
	static private final String                                             DEFAULT_TAG_ATTRIBUTE_TYPE = "string";

    private final RangerDatahubEntity entity;
    private final List<EntityNotificationWrapper.RangerAtlasClassification> tags;
    private final AtlasTypeRegistry                                         typeRegistry;

    public RangerDatahubEntityWithTags(EntityNotificationWrapper notification ) {
        this.entity       = notification.getRangerAtlasEntity();
        this.tags         = notification.getClassifications();
        this.typeRegistry = null;
    }

    public RangerDatahubEntityWithTags(RangerDatahubEntity entity, List<EntityNotificationWrapper.RangerAtlasClassification> tags, AtlasTypeRegistry typeRegistry) {
        this.entity       = entity;
        this.tags         = tags;
        this.typeRegistry = typeRegistry;
    }

    public RangerDatahubEntity getEntity() {
        return entity;
    }
