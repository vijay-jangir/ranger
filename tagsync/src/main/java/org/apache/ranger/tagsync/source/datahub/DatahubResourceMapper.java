...
import org.apache.ranger.tagsync.source.atlasrest.RangerDatahubEntity;
...
public abstract class DatahubResourceMapper {
	...
	public DatahubResourceMapper(String componentName, String[] supportedEntityTypes) {
	...
	abstract public RangerServiceResource buildResource(final RangerDatahubEntity entity) throws Exception;
